...
<main>
  <nav class="flex ml-5 mr-5 sm:ml-10 sm:mr-10 text-black mt-7 items-center">
    <div class="flex-1 justify-start space-x-3 sm:space-x-5">
      <a href="https://github.com/26samaahmed" target="_blank" rel="noopener noreferrer" class="no-underline hover:underline text-2xl">
        <svg class="w-8 h-8 sm:w-10 sm:h-10 inline-block" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 30 30">
