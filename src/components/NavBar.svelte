...
<main>
  <nav class="flex ml-5 mr-5 sm:ml-10 sm:mr-10 text-black mt-7">
    <div class="flex-1 justify-start space-x-3 sm:space-x-8">
      <a href="https://github.com/26samaahmed" target="_blank" rel="noopener noreferrer" class="no-underline hover:underline text-2xl">
        <svg class="w-8 h-8 sm:w-12 sm:h-12 inline-block" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 30 30">
      ...
      <a href="https://www.linkedin.com/in/sama-ahmedd/" target="_blank" rel="noopener noreferrer" class="no-underline hover:underline text-2xl">
        <svg class="w-7 h-7 sm:w-12 sm:h-12 inline-block" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 50 50">
    ...
    <div class="flex justify-end space-x-8">
      {#each buttons as button}
        {#if button.link === '#projects'}
          <a href={button.link} on:click|preventDefault={scrollIntoView} class="no-underline hover:underline text:lg sm:text-2xl text-center">{button.name}</a>
        {:else}
